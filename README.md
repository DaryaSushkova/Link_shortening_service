...
В директории `/images` расположены вспомогательные картинки для данного README.
...
Scheduling, реализованный с помощью `AsyncIOScheduler`, используется в рамках запуска запланированных задач дял очистки данных в БД, а именно:
...
Пример локального запуска на компьютере автора репозитория:<br>
...
1. Создание коротких ссылок для незарегистрированных пользователей
